...
namespace DocDBEventProcessorHostWebJob
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            options.InvokeProcessorAfterReceiveTimeout = true; //will cause checkpointing to fire even when no events to process
            ...
            eventProcessorHost.RegisterEventProcessorAsync<DocDBProcessor>(options);
